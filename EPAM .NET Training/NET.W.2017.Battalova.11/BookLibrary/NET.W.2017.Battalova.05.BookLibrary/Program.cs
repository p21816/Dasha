...
namespace NET.W._2017.Battalova._05.BookLibrary
{
    class Program
    {
       ...
       //     bookListService.SortBooksByTag();
         //   bookListService.SortBooksByTag(new ComparerImplementation());
     //       Console.WriteLine(bookListService.FindBookByTag(new FinderImplementation(), "1"));
            foreach(Book b in bookListService)
            {
